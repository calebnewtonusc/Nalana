...
SEED_SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        "type": "youtube_channel",
        "name": "Ducky 3D",
        "url": "https://www.youtube.com/@Ducky3D",
        "software": "blender",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    },
    {
        "type": "youtube_channel",
        "name": "FlippedNormals",
        "url": "https://www.youtube.com/@FlippedNormals",
        "software": "multi",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    },
    {
        "type": "youtube_channel",
        "name": "Derek Elliott",
        "url": "https://www.youtube.com/@DerekElliott",
        "software": "blender",
        "category": "tutorial",
        "stream": 1,
        "priority": "medium",
    },
    {
        "type": "youtube_channel",
        "name": "SouthernShotty",
        "url": "https://www.youtube.com/@SouthernShotty3D",
        "software": "blender",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    {
        "type": "youtube_channel",
        "name": "Remington Creative",
        "url": "https://www.youtube.com/@RemingtonCreative",
        "software": "blender",
        "category": "tutorial",
        "stream": 1,
        "priority": "medium",
    },
    {
        "type": "youtube_channel",
        "name": "Noggi 3D",
        "url": "https://www.youtube.com/@Noggi3D",
        "software": "blender",
        "category": "tutorial",
        "stream": 1,
        "priority": "medium",
    ...
    # Maya
    {
        "type": "youtube_channel",
        "name": "Autodesk Maya",
        "url": "https://www.youtube.com/@AutodeskMaya",
        "software": "maya",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        "type": "youtube_channel",
        "name": "Maya Central",
        "url": "https://www.youtube.com/@MayaCentral3D",
        "software": "maya",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        "type": "youtube_channel",
        "name": "Arrimus 3D",
        "url": "https://www.youtube.com/@Arrimus3D",
        "software": "multi",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        "type": "youtube_channel",
        "name": "Alex Cheparev",
        "url": "https://www.youtube.com/@alexcheparev",
        "software": "maya",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        "type": "youtube_channel",
        "name": "CGCircuit",
        "url": "https://www.youtube.com/@cgcircuit",
        "software": "maya",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    # Houdini
    {
        "type": "youtube_channel",
        "name": "SideFX",
        "url": "https://www.youtube.com/@SideFXHoudini",
        "software": "houdini",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    {
        "type": "youtube_channel",
        "name": "Houdini Tutorial",
        "url": "https://www.youtube.com/@houdinitutorial",
        "software": "houdini",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    {
        "type": "youtube_channel",
        "name": "Tim van Helsdingen",
        "url": "https://www.youtube.com/@TimvanHelsdingen",
        "software": "houdini",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        "type": "youtube_channel",
        "name": "Indie-Pixel",
        "url": "https://www.youtube.com/@Indie-Pixel",
        "software": "houdini",
        "category": "tutorial",
        "stream": 1,
        "priority": "medium",
    ...
    # Cinema 4D
    {
        "type": "youtube_channel",
        "name": "Maxon",
        "url": "https://www.youtube.com/@Maxon3D",
        "software": "c4d",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        ...
        "url": "https://www.youtube.com/@SchoolofMotion",
        "software": "c4d",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    },
    {
        "type": "youtube_channel",
        "name": "JROTools",
        "url": "https://www.youtube.com/@JROTools",
        "software": "substance",
        "category": "tutorial",
        "stream": 1,
        "priority": "medium",
    ...
    # Rhino / Grasshopper
    {
        "type": "youtube_channel",
        "name": "McNeel",
        "url": "https://www.youtube.com/@McNeel",
        "software": "rhino",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    },
    {
        ...
        "url": "https://www.youtube.com/@ParametricArchitecture",
        "software": "rhino",
        "category": "tutorial",
        "stream": 1,
        "priority": "medium",
    ...
    },
    {
        ...
        "url": "https://www.youtube.com/@GnomonWorkshop",
        "software": "multi",
        "category": "tutorial",
        "stream": 1,
        "priority": "high",
    ...
    {
        "type": "youtube_channel",
        "name": "Art of Rendering",
        "url": "https://www.youtube.com/@ArtofRendering",
        "software": "multi",
        "category": "design_theory",
        "stream": 1,
        "priority": "medium",
    ...
    },
    {
        ...
        "stream": 2,
        "priority": "high",
        "notes": "10M+ 3D objects",
    },
    {
        "type": "dataset",
        "name": "ShapeNet",
        "url": "https://huggingface.co/datasets/ShapeNet/ShapeNetCore",
        "software": "multi",
        "category": "geometry",
        "stream": 2,
        "priority": "high",
        "notes": "55k+ 3D CAD models, 55 categories",
    },
    {
        "type": "dataset",
        "name": "ABC Dataset",
        ...
        "stream": 2,
        "priority": "high",
        "notes": "1M+ CAD models with ground truth",
    },
    {
        "type": "dataset",
        "name": "Thingi10K",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "10k real-world 3D printing models",
    },
    {
        "type": "dataset",
        "name": "ScanNet",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "Indoor RGB-D scans with semantic labels",
    },
    {
        "type": "dataset",
        "name": "ABO",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "Amazon Berkeley Objects — product 3D",
    },
    {
        "type": "dataset",
        "name": "LVIS",
    ...
    },
    {
        "type": "dataset",
        "name": "3D-FUTURE",
        "url": "https://tianchi.aliyun.com/specials/promotion/alibaba-3d-future",
        "software": "multi",
        "category": "geometry",
        "stream": 2,
        "priority": "medium",
        "notes": "Furniture 3D models with CAD",
    },
    {
        "type": "api",
        "name": "Sketchfab API",
        "url": "https://sketchfab.com/developers/data-api/v3",
        "software": "multi",
        "category": "geometry",
        "stream": 2,
        "priority": "high",
        "notes": "CC-licensed 3D models, Python client available",
    },
    {
        "type": "api",
        "name": "Polyhaven API",
        ...
        "stream": 2,
        "priority": "high",
        "notes": "CC0 HDRIs, materials, meshes",
    },
    {
        "type": "api",
        "name": "Thingiverse API",
    ...
    },
    {
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "7M+ engineering CAD files",
    },
    {
        "type": "dataset",
        "name": "Printables",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "Prusa 3D printing community",
    },
    {
        "type": "dataset",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "Public domain spacecraft, planetary models",
    },
    {
        "type": "dataset",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "Medical and anatomical 3D models",
    },
    {
        "type": "dataset",
        "name": "Smithsonian 3D",
        ...
        "stream": 2,
        "priority": "medium",
        "notes": "Museum objects, CC0",
    },
    # ── Stream 3: Physics & optics knowledge ───────────────────────────────────
    {
        "type": "paper",
        "name": "Physically Based Rendering (PBR book)",
        "url": "https://pbr-book.org/",
        "software": "multi",
        "category": "physics",
        "stream": 3,
        "priority": "high",
        "notes": "Pharr, Jakob, Humphreys — full text online",
    },
    {
        "type": "paper",
        "name": "Cook-Torrance 1982",
    ...
    {
        "type": "paper",
        "name": "Donner & Jensen SSS",
        "url": "https://graphics.ucsd.edu/papers/sss-spectral/",
        "software": "multi",
        "category": "physics",
        "stream": 3,
        "priority": "high",
        "notes": "Measured skin scattering data",
    },
    {
        "type": "paper",
        "name": "MERL BRDF Database",
        "url": "https://merl.com/brdf/",
        "software": "multi",
        "category": "physics",
        "stream": 3,
        "priority": "high",
        "notes": "Measured BRDFs for 100 real materials",
    },
    {
        "type": "docs",
        ...
        "stream": 3,
        "priority": "high",
        "notes": "IOR database for all real materials",
    },
    {
        "type": "docs",
        "name": "ShaderToy",
        ...
        "stream": 3,
        "priority": "medium",
        "notes": "GLSL shader examples, procedural techniques",
    },
    {
        "type": "docs",
        "name": "Feynman Lectures EM",
    ...
    },
    {
        "type": "docs",
        "name": "OpenGL Spec",
        "url": "https://registry.khronos.org/OpenGL/specs/gl/",
        "software": "multi",
        "category": "reference",
        "stream": 3,
        "priority": "low",
    },
    {
        "type": "docs",
        "name": "Vulkan Spec",
        "url": "https://registry.khronos.org/vulkan/specs/",
        "software": "multi",
        "category": "reference",
        "stream": 3,
        "priority": "low",
    },
    {
        ...
        "stream": 3,
        "priority": "medium",
        "notes": "CFD solver — fluid simulation ground truth",
    },
    # Architecture & design theory
    {
        ...
        "stream": 3,
        "priority": "medium",
        "notes": "Architecture visualization references",
    },
    {
        "type": "dataset",
        "name": "IFC Open Building Models",
        "url": "https://www.ifcwiki.org/index.php/Open_BIM_Models",
        "software": "rhino",
        "category": "geometry",
        "stream": 3,
        "priority": "medium",
        "notes": "IFC BIM models for architectural training",
    },
    {
        "type": "dataset",
        "name": "CyArk",
        "url": "https://www.cyark.org/data/",
        "software": "multi",
        "category": "geometry",
        "stream": 3,
        "priority": "low",
        "notes": "Photogrammetry of heritage sites",
    },
    # ── Stream 4: Community & multi-turn ───────────────────────────────────────
    {
        ...
        "stream": 4,
        "priority": "high",
        "notes": "Q&A threads with expert replies",
    },
    {
        "type": "forum",
        "name": "Polycount",
        ...
        "stream": 4,
        "priority": "high",
        "notes": "Game art topology crits, feedback threads",
    },
    {
        "type": "forum",
        "name": "CGSociety",
    ...
    {
        "type": "forum",
        "name": "SideFX Houdini Forum",
        "url": "https://www.sidefx.com/forum/",
        "software": "houdini",
        "category": "community",
        "stream": 4,
        "priority": "high",
    },
    {
        ...
        "stream": 4,
        "priority": "low",
        "notes": "Process posts with workflow breakdowns",
    },
    # ── Stream 5: Cross-software & integration ─────────────────────────────────
    {
        "type": "dataset",
        "name": "AMASS Motion Capture",
        "url": "https://amass.is.tue.mpg.de/",
        "software": "multi",
        "category": "animation",
        "stream": 5,
        "priority": "high",
        "notes": "50h+ of MoCap data for rigging training",
    },
    {
        "type": "dataset",
        "name": "CMU MoCap",
    ...
    },
    {
        "type": "docs",
        "name": "glTF Spec",
        "url": "https://registry.khronos.org/glTF/specs/2.0/",
        "software": "multi",
        "category": "reference",
        "stream": 5,
        "priority": "medium",
    ...
    },
    {
        ...
        "url": "https://help.autodesk.com/view/MAYAUL/2024/ENU/?guid=Maya_SDK_Maya_Python_API_html",
        "software": "maya",
        "category": "reference",
        "stream": 5,
        "priority": "high",
    ...
    {
        "type": "dataset",
        "name": "HF 3D datasets hub",
        "url": "https://huggingface.co/datasets?task_categories=task_categories%3Aother&sort=likes&search=3d",
        "software": "multi",
        "category": "geometry",
        "stream": 2,
        "priority": "medium",
    ...
    {
        "type": "dataset",
        "name": "Papers With Code 3D",
        "url": "https://paperswithcode.com/area/computer-vision/3d-vision",
        "software": "multi",
        "category": "geometry",
        "stream": 2,
        "priority": "medium",
...
async def expand_sources(
    ...
    for rnd in range(rounds):
        print(
            f"  Expansion round {rnd + 1}/{rounds} ({len(all_sources)} sources so far)..."
        )
...
async def _run(args: argparse.Namespace) -> None:
    ...
    async with httpx.AsyncClient() as client:
        if not args.no_expand:
            ...
            print(
                f"  Done ({time.time() - t0:.0f}s). Sample scores: "
                + ", ".join(
                    f"{s['name']}={s.get('relevance_score', 0):.2f}"
                    for s in sources[:4]
                )
            )
            ...
            for s in sources:
                s.setdefault(
                    "relevance_score",
                    priority_to_score.get(s.get("priority", "medium"), 0.5),
                )
                s.setdefault("tags", [])
    ...
    print(
        "By stream:        "
        + "  ".join(f"S{k}:{v}" for k, v in sorted(by_stream.items()))
    )
    print(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", default="data/discovered_sources.json", help="Output JSON file path"
    )
    parser.add_argument(
        "--backend",
        choices=["vllm", "claude"],
    ...
    parser.add_argument(
        "--vllm-url", default=os.environ.get("VLLM_URL", "http://localhost:8001")
    )
    parser.add_argument(
    ...
    if not args.no_expand:
        if args.backend == "claude" and not args.claude_api_key:
            parser.error(
                "Set ANTHROPIC_API_KEY or pass --claude-api-key (or use --no-expand)"
            )
