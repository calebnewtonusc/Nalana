...
TOPOLOGY_RULES: dict[str, Any] = {
    ...
    "pole_rules": {
        "n_pole": {
            ...
            "ideal_use":    ["sharp corners", "hard-surface creases", "controlled termination of edge loops"],
        ...
        "e_pole": {
            ...
            "ideal_use":    ["redirecting edge flow", "topology transitions", "ear bases", "finger webbing"],
